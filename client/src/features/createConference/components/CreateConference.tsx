...
import { useConferenceMutation } from '../querries'
...
import { TFormConferenceData } from '../types'
...
const CreateConference = () => {
  const { mutate } = useConferenceMutation()
  const { handleSubmit, control, setError } = useForm<TFormConferenceData>({
    defaultValues: {
      conferenceName: '',
      conferencePassword: '',
      conferenceId: uuidv4()
